<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/COC.Master" AutoEventWireup="true" CodeBehind="COC_SCR_009.aspx.cs" Inherits="COC.Application.COC_SCR_009" %>
            ...
            <table cellpadding="2" cellspacing="0" border="0" >
                ...
                <tr>
                    ...
                    <td class="style3">
                        <asp:DropDownList ID="cmbBranchCode" runat="server" CssClass="Dropdownlist" 
                            ...
                            onselectedindexchanged="cmbBranchCode_SelectedIndexChanged"></asp:DropDownList>
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td class="style3">
                        <asp:DropDownList ID="cmbDepartment" runat="server" CssClass="Dropdownlist" Width="262px"></asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td style="width:10px"></td>
                    ...
                    <td class="style3">
                        <asp:DropDownList ID="cmbCocTeam" runat="server" CssClass="Dropdownlist" Width="262px"></asp:DropDownList>

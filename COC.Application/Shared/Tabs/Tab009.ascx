<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Tab009.ascx.cs" Inherits="COC.Application.Shared.Tabs.Tab009" %>
    ...
    <script language="javascript" type="text/javascript">
        function ConfirmSave() {
            ...
            if (detail.trim() == '') {
                ...
                if (detail.trim().length > '<%= COC.Application.Utilities.AppConstant.TextMaxLength %>') {
                    errorMsg.innerHTML = 'ไม่สามารถบันทึกรายละเอียด Note เกิน ' + '<%= COC.Application.Utilities.AppConstant.TextMaxLength %>' + ' ตัวอักษรได้';
                    return false;
                }
            }
            ...
            <asp:GridView ID="gvNoteHistory" runat="server" AutoGenerateColumns="False" DataKeyNames="TicketId"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="CreateBy" HeaderText="ผู้สร้าง Note">
                        ...
                        <ItemStyle Width="190px" HorizontalAlign="Left" VerticalAlign="Top"  />
                    </asp:BoundField>
                    ...
                    <asp:BoundField DataField="NoteDetail" HeaderText="บันทึก Note">
                        <HeaderStyle Width="454" HorizontalAlign="Center"/>
                        <ItemStyle Width="454" HorizontalAlign="Left" VerticalAlign="Top"   />
                    </asp:BoundField>

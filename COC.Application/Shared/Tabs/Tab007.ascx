<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Tab007.ascx.cs" Inherits="COC.Application.Shared.Tabs.Tab007" %>
...
<div style="font-family:Tahoma; font-size:13px;">
    <asp:UpdatePanel ID="upResult" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <asp:Panel ID="pnOwnerLogging" runat="server" Width="1170px" ScrollBars="Auto" >
                <asp:GridView ID="gvOwnerLogging" runat="server" AutoGenerateColumns="False" DataKeyNames="TicketId"
                    ...
                    <asp:BoundField DataField="OldStatusDesc" HeaderText="สถานะเดิม">
                        <HeaderStyle Width="150px" HorizontalAlign="Center"/>
                        <ItemStyle Width="150px" HorizontalAlign="Left" VerticalAlign="Top" />
                    </asp:BoundField>
                    <asp:BoundField DataField="NewStatusDesc" HeaderText="สถานะใหม่">
                        <HeaderStyle Width="150px" HorizontalAlign="Center"/>
                        <ItemStyle Width="150px" HorizontalAlign="Left" VerticalAlign="Top" />
                    </asp:BoundField>
